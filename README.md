...
2. At the top bar, click "Import Templates"<br />
...
1. In the Elementor editor, click the folder icon to open the templates modal.<br />
...
3. Select the template you would like to use and click "Insert" on the right.<br />
